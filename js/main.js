...
function Dog(someArray, name, image, sex, color, breed, age) {
    ...
    this.populateHTML = function () {
        ...
        container.className = "d-inline-block col-xs-12 col-sm-6 col-md-6 col-xl-4 mt-5 animated fadeInUp";
...
footer.style.backgroundRepeat = "r";
